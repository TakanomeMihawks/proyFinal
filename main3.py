...
###=========Version============= 
		...
		while char != "No encontrado":
			char =obj.busqueda(obj,manejador,"version",ok,126,32,indiceY,1,"")
			#print "Caracter: "+char
...
###=========Bases===============
		...
		while char == "No encontrado" and bandera != 1:
			...
			while char != "No encontrado":
				...
				char =obj.busqueda(obj,manejador,"bases",ok,126,32,indiceY,indiceX,"")
				#print "Caracter: "+char
				if char != "No encontrado":
					base += char
					indiceY = indiceY +1
...
###=========Current============= 
		...
		char = ""
		while char != "No encontrado":
			char =obj.busqueda(obj,manejador,"current",ok,126,32,indiceY,1,"")
			#print "Caracter: "+char
			if char != "No encontrado":
				current += char
				indiceY = indiceY +1
			...
			for where in bases.keys():
				...
				while char == "No encontrado" and bandera != 1:
					...
					while char != "No encontrado":
						...
						char =obj.busqueda(obj,manejador,"tablas",ok,126,32,indiceY,indiceX,condicion)
						#print "Caracter: "+char
						if char != "No encontrado":
							tabla += char
							indiceY = indiceY +1
